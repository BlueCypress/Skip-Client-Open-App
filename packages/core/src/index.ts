/**
 * @askskip/core — shared foundation for the Skip Client Open App.
 *
 ...
 * The heavy runtime package `@askskip/server` depends on this for those helpers, and the
 ...
 * circular dependency (server -> core, never the reverse).
 *
